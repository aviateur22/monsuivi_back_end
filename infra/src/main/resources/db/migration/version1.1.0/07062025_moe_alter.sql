...
ALTER table IF EXISTS sc_monsuivi.product_category OWNER TO monsuivi_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_monsuivi.product_category TO monsuivi_moe;
...
ALTER table IF EXISTS sc_monsuivi.product_category_color OWNER TO monsuivi_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_monsuivi.product_category_color TO monsuivi_moe;
