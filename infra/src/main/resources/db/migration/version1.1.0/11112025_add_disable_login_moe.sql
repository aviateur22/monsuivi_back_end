...
ALTER table IF EXISTS sc_monsuivi.disable_login OWNER TO monsuivi_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_monsuivi.disable_login TO monsuivi_moe;

CREATE SEQUENCE if not exists sc_monsuivi.disable_login_pk_seq START WITH 1 INCREMENT BY 1 NO CYCLE;
ALTER SEQUENCE if exists sc_monsuivi.disable_login_pk_seq OWNER TO monsuivi_moe;
